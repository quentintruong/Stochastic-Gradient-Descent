...
Skeleton for simulated annealing, currently is only stochastic gradient descent
*/
...
class Controller{
	...
	SGD(max_iterations, max_temp, temp_change_type){
		...
		while (true){
			...
			//Not minibatch, is choosing of only one
			if (i_cost <= curr_cost){
